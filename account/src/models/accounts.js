...
const accountsSchema = new mongoose.Schema(
    {
        ...
        password: {type: String, required: true, minLength: 9, validate: {
        ...
        phone: { type: String,
          validate: {
          validator: function(v) {
          return /^\+?([0-9]{2})\)?[-. ]?([0-9]{2})?[-. ]?([0-9]{5})[-. ]?([0-9]{4})$/.test(v);
        ...
        address: [{
          ...
          state: {type: String, required: true, default: "AC", enum: { values: ["AC", "AL", "AM", "AP", "BA", "CE", "DF", "ES", "GO", "MA", "MG", "MS", "MT", "PA", "PB", "PE", "PI", "PR", "RJ", "RN", "RO", "RR", "RS", "SC", "SE", "SP", "TO"]},},
          status: {type: Boolean},
